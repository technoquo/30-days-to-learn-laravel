...
<head>
    ...
    <title>My Website Laravel 11</title>
                ...
                <div class="flex h-16 items-center justify-between">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                           @guest
                            <x-nav-link href="/login" class="cursor-pointer" :active="request()->is('login')" >Login</x-nav-link>
                            <x-nav-link href="/register" class="cursor-pointer" :active="request()->is('register')" >Register</x-nav-link>
                           @endguest
                           @auth
